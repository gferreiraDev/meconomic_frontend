  ...
  const chartData = [
    {
      ...
      type: 'line',
      fill: 'solid',
      data: [945.69, 606.05, 2623.33, 1032.33, 1224.13, 1978.18, 1277.89, 2731.49, 1661.55, 1639.29, 742.91, 898.95],
    },
    {
      name: 'Receita Total',
      type: 'line',
      fill: 'solid',
      data: [2899.2, 2293.12, 2488.31, 2306.93, 2460.98, 2650.53, 2154.81, 3111.38, 2851.56, 2168.59, 3278.24, 2419.66],
    },
    {
      name: 'Saldo',
      type: 'column',
      fill: 'solid',
      data: [1953.51, 1686.07, 135.02, 1247.6, 1236.85, 672.35, 876.92, 386.89, 1190.01, 529.3, 2535.33, 1520.71],
    },
  ];
      ...
      {loading ? (
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={6} lg={8}>
            <LineChart title="Desempenho por mês" subtitle="(+25%) de variação" labels={labels} data={[...chartData]} />
          </Grid>
