...
const CardImage = ({ name, lastNumbers, brand }) => {
  return (
    <Box
      sx={{
        height: 80,
    ...
    >
      ...
      <Typography variant="caption" align="right" sx={{ fontStyle: 'italic' }}>
        {brand}
      </Typography>
    </Box>
  );
...
const List = ({ columns, rows, selected, setSelected, onEdit, onDelete }) => {
